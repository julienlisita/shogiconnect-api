...
const createUserStat = async (req, res) => {
    try {
        ...
        if (user) {
            ...
            res.status(201).json({ message: `UserStat créé`, data: result });
        } else {
...
const updateUserStat = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'UserStat modifié', data: result });
    } catch (error) {
        errorHandler(error, res);
    }
};
...
const deleteUserStat = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'UserStat supprimé', data: result });
    } catch (error) {
        errorHandler(error, res);
    }
};
